    ...
    await queryInterface.sequelize.query(`
      create or replace function is_age_eligibility_requirement_met(
        ...
        select
          ...
          -- age eligibility is listed AND exists at least one eligibility that fulfills the ffollowing criteria:
          (
            select count(1) 
            ...
            where
               ...
               (age_min is not null and age_max is not null and age <= age_max and age >= age_min) OR
